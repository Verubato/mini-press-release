...
|---|---|
| Version | 2.7.3 |
| Interface versions (.toc) | 120100, 120007, 50504, 40402, 38002, 38000, 30405, 20506, 11509 (spans retail 12.x, Mists Classic 5.5.x, Cata Classic 4.4.x, Wrath 3.4.x, TBC 2.5.6, Classic Era 1.15.x) |
